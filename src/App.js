  ...
  return (
    <>
      ...
      <div style={{ background: C.surface, borderRadius: 12, padding: "13px 15px", border: "1.5px solid " + C.border, borderLeft: "4px solid " + (e.gps ? C.accent : C.borderStrong) }}>
        ...
        {e.categoria && <div style={{ marginTop: 4, fontSize: 11, color: C.accent, fontFamily: "monospace", background: C.accentLight, padding: "4px 8px", borderRadius: 6, display: "inline-block" }}>📍 {e.categoria}</div>}
      </div>
    </>
  );
}
