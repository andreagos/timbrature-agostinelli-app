...
function EntryCard({ entry: e, onDelete, showEdit: canEdit }) {
  ...
  const CATEGORIE = ["Manutenzione del verde agriturismo","Cucina","Servizio evento","Preparazione carne","Pulizie generali","Giardino Giovanni","Giardino Fabio","Giardino Villa","Giardino Lorenzo","Giardino Tommaso","Giardino Andrea","Giardino Adriano (Como)","Consegne","Altro"];
