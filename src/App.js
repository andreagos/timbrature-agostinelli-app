...
function EntryCard({ entry: e, onDelete, showEdit: canEdit }) {
  ...
  const CATEGORIE = ["Manutenzione del verde agriturismo","Cucina","Servizio evento","Preparazione carne","Pulizie generali","Giardino Giovanni","Giardino Fabio","Giardino Villa","Giardino Lorenzo","Giardino Tommaso","Giardino Andrea","Giardino Adriano","Consegne","Altro"];
                ...
                <>
                  ...
                  <div style={{ marginBottom: 16, textAlign: "left" }}>
                    ...
                    <select value={categoria} onChange={e => setCategoria(e.target.value)} style={S.select}>
                      ...
                      <option value="Giardino Adriano">Giardino Adriano</option>
